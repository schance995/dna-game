...
sys.path.append('.')
import gene
from gene.ddd import DDDGene
from gene.zne import ZNEGene
from gene.rem import REMGene
...
def mutate(chromosome):
	...
	match c:
		case REMGene(): gene.rem.mutate(c)
		case ZNEGene(): gene.zne.mutate(c)
		case DDDGene(): gene.ddd.mutate(c)
	return chromosome
